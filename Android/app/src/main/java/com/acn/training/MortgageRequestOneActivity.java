...
public class MortgageRequestOneActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mortgagerequestone);
		...
		countryButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					Intent intent = new Intent(MortgageRequestOneActivity.this, CountryListActivity.class);
		...
		nextButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					Intent intent = new Intent(MortgageRequestOneActivity.this, MortgageRequestTwoActivity.class);
