...
public class PaymentHomeActivity extends Activity {
	...
	private Button makePaymentButton, mortgageRequestButton, expenseReportButton, logoutButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mortgageRequestButton = (Button) findViewById(R.id.mortgageRequestButton);
        ...
        mortgageRequestButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				try {
					startActivity(new Intent(PaymentHomeActivity.this, MortgageRequestOneActivity.class));
				} catch (Exception ex) {
					Log.e(this.getClass().getName(), "Error : " + ex.getMessage(), ex);
				}
			}
